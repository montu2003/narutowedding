...
document.addEventListener("DOMContentLoaded", function () {
    // Load the heart preloader HTML dynamically
    var preloaderContainer = document.getElementById("preloader-container");
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "css/heart.html", true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            preloaderContainer.innerHTML = xhr.responseText;

            // Set a timeout to replace the preloader with the main content after 10 seconds
            setTimeout(function () {
                preloaderContainer.style.display = "none"; // Hide the preloader
